...
def load_edge_index(cGridCell):
    if machine == 0:
        sample_array = np.loadtxt("/home/yrayhan/works/aerebus/kb_quad/" + str(CPUID[0]) + "/query_view.txt")
    else:
        sample_array = np.loadtxt("/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(CPUID[0]) + "/query_view.txt")
    edge_indexes = [[] for _ in range(sample_array.shape[0])]
    edge_indexes_w = [[] for _ in range(sample_array.shape[0])]

    for _ in CPUID:
        if machine == 0:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_quad/" + str(_) + "/query_view.txt"
        else:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(_) + "/query_view.txt"
...
def load_grid_features_ts(cGridCell, nFeatures):
    ...
    # => july 16
    if machine == 0:
        sample_array = np.loadtxt("/home/yrayhan/works/aerebus/kb_quad/" + str(CPUID[0]) + "/data_view.txt")
    else:
        sample_array = np.loadtxt("/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(CPUID[0]) + "/data_view.txt")
    ...
    for _ in CPUID:
        # => july 16
        if machine == 0:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_quad/" + str(_) + "/data_view.txt"
        else:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(_) + "/data_view.txt"
...
def load_system_features(cntNUMANode, cntMCChannels):
    if machine == 0:
        RAW_FILE = "/home/yrayhan/works/aerebus/kb_quad/" + str(CPUID[0]) + "/mem-channel_view.txt"
        raw_array = np.loadtxt(RAW_FILE)
        read_channels = raw_array[:, 2:2 + cntMCChannels * cntNUMANode]
        write_channels = raw_array[:, 2 + cntMCChannels * cntNUMANode:]
    else:
        RAW_FILE = "/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(CPUID[0]) + "/mem-channel_view.txt"
        raw_array = np.loadtxt(RAW_FILE)
...
def load_query_throughput():
    ...
    for _ in CPUID:
        if machine == 0:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_quad/" + str(_) + "/query-exec_view.txt"
        else:
            RAW_FILE = "/home/yrayhan/works/aerebus/kb_icelake_quad/" + str(_) + "/query-exec_view.txt"
...
def load_machine_adjacency():
    ...
    RAW_FILE = "/home/yrayhan/works/aerebus/machine_configs/raw_config.txt"
    raw_array = np.loadtxt(RAW_FILE)
...
def sth(cfg_idx):
    ...
    cfg = np.loadtxt("/home/yrayhan/works/aerebus/machine_configs/config_" + str(cfg_idx) + ".txt")[10:]
