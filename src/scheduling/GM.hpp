...
// -------------------------------------------------------------------------------------
#define SINGLE_DIMENSION_KEY_LIMIT 1500000000 // 343901273, 200000000
#define BTREE_INIT_LIMIT 500000000
#define LIMIT 1000                
...
# define USE_MODEL 0 
// -------------------------------------------------------------------------------------
#define MACHINE 2   // 0 (BIGDATA), 1(DBSERVER), 2 (AMD 1NPS), 3 (AMD 4NPS), NVIDIA (4), SB (5), SKX(4S4N) 6, 8 (IBM)
#define MULTIDIM 0 
